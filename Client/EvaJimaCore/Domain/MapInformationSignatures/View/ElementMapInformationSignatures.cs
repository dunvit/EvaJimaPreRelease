...
namespace EveJimaCore.Domain.MapInformationSignatures.View
{
    public partial class ElementMapInformationSignatures : Form, IMapInformationSignaturesView, IView, IMapInformationView
    {
        ...
        public ElementMapInformationSignatures()
        {
            InitializeComponent();
        }
        ...
        private void ejButton2_Click(object sender, EventArgs e)
        {
